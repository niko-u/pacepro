      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-8">
            ...
            <span className="font-semibold text-xl text-white">PacePro</span>
          </Link>
          <h1 className="text-2xl font-bold text-white mb-2">Start your journey</h1>
          <p className="text-zinc-400">Create your account and get your first plan</p>
        </div>
        ...
        <div className="bg-zinc-800/50 border border-zinc-700 rounded-2xl p-8">
          <Button
            ...
            variant="outline"
            className="w-full h-12 border-zinc-600 text-white hover:bg-zinc-700 mb-6"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-zinc-800/50 px-2 text-zinc-500">or</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white border-0"
            >
